function(BuildGoogleClient)
  ...
  elseif (APPLE)
    ...
    list(APPEND GOOGLE_CLOUD_LIBS_LIST "lib${LIBSUFFIX}/google_cloud_cpp_common.so")
    list(APPEND GOOGLE_CLOUD_LIBS_LIST "lib${LIBSUFFIX}/storage_client.so")
  endif()
  ...
  if (WIN32)
    ...
    list(APPEND GOOGLE_CLOUD_CMAKE_ARGS "-Dabsl_DIR=${absl_INSTALL_INT_CONFIG}")
  endif()
  ...
  if (WIN32)
    ...
    list(APPEND GOOGLE_CLOUD_CMAKE_ARGS "-DCrc32c_DIR=${crc32c_INSTALL_INT_CONFIG}")
  endif()
