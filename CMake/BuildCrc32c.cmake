function(BuildCrc32c)
  ...
  BuildExternal(crc32c ${crc32c_VERSION} "" ${crc32c_SOURCE_DIR} "${CRC32C_LIBS_LIST}" "" "" "" "-DCMAKE_POSITION_INDEPENDENT_CODE=ON;-DCRC32C_BUILD_TESTS=OFF;-DCRC32C_BUILD_BENCHMARKS=OFF;-DCRC32C_USE_GLOG=OFF")
