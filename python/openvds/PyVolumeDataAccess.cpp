...
// AUTOGENERATE FAIL :   VolumeDataAccessManager_.def("getCurrentUploadError"       , static_cast<void(VolumeDataAccessManager::*)(const char **, int32_t *, const char **)>(&VolumeDataAccessManager::GetCurrentUploadError), OPENVDS_DOCSTRING(VolumeDataAccessManager_GetCurrentUploadError));
  ...
  VolumeDataPage_.def("getMinMax"                   , [](VolumeDataPage* self, py::array_t<int>& arg0, py::array_t<int>& arg1) { return self->GetMinMax((int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg0), (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg1)); }, OPENVDS_DOCSTRING(VolumeDataPage_GetMinMax));
  VolumeDataPage_.def("getMinMaxExcludingMargin"    , [](VolumeDataPage* self, py::array_t<int>& arg0, py::array_t<int>& arg1) { return self->GetMinMaxExcludingMargin((int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg0), (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg1)); }, OPENVDS_DOCSTRING(VolumeDataPage_GetMinMaxExcludingMargin));
  VolumeDataPage_.def("getBuffer"                   , [](VolumeDataPage* self, py::array_t<int>& arg0) { return self->GetBuffer((int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg0)); }, OPENVDS_DOCSTRING(VolumeDataPage_GetBuffer));
  VolumeDataPage_.def("getWritableBuffer"           , [](VolumeDataPage* self, py::array_t<int>& arg0) { return self->GetWritableBuffer((int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg0)); }, OPENVDS_DOCSTRING(VolumeDataPage_GetWritableBuffer));
  VolumeDataPage_.def("updateWrittenRegion"         , [](VolumeDataPage* self, const py::array_t<int>& arg0, const py::array_t<int>& arg1) { return self->UpdateWrittenRegion((const int (&)[6])*PyArrayAdapter<int, 6, false>::getArrayBufferChecked(arg0), (const int (&)[6])*PyArrayAdapter<int, 6, false>::getArrayBufferChecked(arg1)); }, OPENVDS_DOCSTRING(VolumeDataPage_UpdateWrittenRegion));
  ...
  VolumeDataPageAccessor_.def("getNumSamples"               , [](VolumeDataPageAccessor* self, py::array_t<int>& arg0) { return self->GetNumSamples((int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg0)); }, OPENVDS_DOCSTRING(VolumeDataPageAccessor_GetNumSamples));
  ...
  VolumeDataPageAccessor_.def("getChunkMinMax"              , [](VolumeDataPageAccessor* self, int64_t arg0, py::array_t<int>& arg1, py::array_t<int>& arg2) { return self->GetChunkMinMax(arg0, (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg1), (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg2)); }, OPENVDS_DOCSTRING(VolumeDataPageAccessor_GetChunkMinMax));
  VolumeDataPageAccessor_.def("getChunkMinMaxExcludingMargin", [](VolumeDataPageAccessor* self, int64_t arg0, py::array_t<int>& arg1, py::array_t<int>& arg2) { return self->GetChunkMinMaxExcludingMargin(arg0, (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg1), (int (&)[6])*PyArrayAdapter<int, 6, true>::getArrayBufferChecked(arg2)); }, OPENVDS_DOCSTRING(VolumeDataPageAccessor_GetChunkMinMaxExcludingMargin));
  VolumeDataPageAccessor_.def("getChunkIndex"               , [](VolumeDataPageAccessor* self, const py::array_t<int>& arg0) { return self->GetChunkIndex((const int (&)[6])*PyArrayAdapter<int, 6, false>::getArrayBufferChecked(arg0)); }, OPENVDS_DOCSTRING(VolumeDataPageAccessor_GetChunkIndex));
  ...
  VolumeDataPageAccessor_.def("readPageAtPosition"          , [](VolumeDataPageAccessor* self, const py::array_t<int>& arg0) { return self->ReadPageAtPosition((const int (&)[6])*PyArrayAdapter<int, 6, false>::getArrayBufferChecked(arg0)); }, OPENVDS_DOCSTRING(VolumeDataPageAccessor_ReadPageAtPosition));
