...
public class AWSSliceDumpDemo {
    ...
    static void process(String[] args) throws Exception {
        ...
        System.out.println("Create AWS dataset...");
        final AWSOpenOptions o = new AWSOpenOptions();
//        o.key = "vds/alwynDepth_w_IL_XL_IEEEFloat";
        o.key = "vds/psdn11_TbsdmF_full_w_AGC_Nov11.segy";
        o.bucket = "openvds-test-int";
        o.region = "eu-west-3";
        final VdsHandle generator = OpenVDS.open(o);
